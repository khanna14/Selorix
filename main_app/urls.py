...
urlpatterns = [
    ...
    path("holiday_list", ceo_views.admin_home,
         name='holiday_list'),                           ######################## UPDATE
    ...
    path('holidays/', ceo_views.holiday_list, name='holiday_list'),
    path('holidays/add/', ceo_views.add_holiday, name='add_holiday'),
    path('holidays/delete/<int:pk>/', ceo_views.delete_holiday, name='delete_holiday'),
